...
import k4ustu3h.monocons.ui.components.core.ListRowDescription
import k4ustu3h.monocons.ui.components.core.ListRowLabel
import k4ustu3h.monocons.ui.components.core.rememberAnimatedShape
...
fun AnnouncementCard(
    ...
    Surface(
        ...
        Row(
            ...
            AsyncImage(
                model = ImageRequest.Builder(LocalContext.current).data(icon).crossfade(true)
                    .build(),
