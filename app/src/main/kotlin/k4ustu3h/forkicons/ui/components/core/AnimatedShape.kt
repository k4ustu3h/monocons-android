 ...
 * Modifications copyright 2026 Lawnchair Launcher
 *
...
package k4ustu3h.forkicons.ui.components.core
...
// Port of animated shape from AOSP as of e6d33dd5d0a60001a5784d84123b05308d35f410

private const val CENTER_OPTICALLY_COEFFICIENT = 0.11f

private interface ShapeWithHorizontalCenterOptically : Shape {
    fun offset(): Float
}
    ...
    return remember(density, state) {
        object : ShapeWithHorizontalCenterOptically {
            ...
            override fun offset(): Float {
                ...
                return CENTER_OPTICALLY_COEFFICIENT * (avgStart - avgEnd)
            }
